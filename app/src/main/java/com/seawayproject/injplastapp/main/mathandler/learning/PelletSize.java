package com.seawayproject.injplastapp.main.mathandler.learning;
 ...
 **/
public class PelletSize extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pellet_activity);
    }
}
