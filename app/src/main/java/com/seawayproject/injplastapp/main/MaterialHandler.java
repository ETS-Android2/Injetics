 ...
 **/
public class MaterialHandler extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mathandler_activity);
    ...
    private void initializeData() {
        String[] titleArray = getResources()
                .getStringArray(R.array.mathandler_titles);
        String[] descArray = getResources()
                .getStringArray(R.array.mathandler_description);
        TypedArray imageResources = getResources()
                .obtainTypedArray(R.array.mathandler_images);
