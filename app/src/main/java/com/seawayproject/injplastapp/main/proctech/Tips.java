package com.seawayproject.injplastapp.main.proctech;
...
public class Tips extends AppCompatActivity {
    ...
    private void initializeData() {
        String[] titleArray = getResources()
                .getStringArray(R.array.proctech_tip_titles);
        String[] descArray = getResources()
                .getStringArray(R.array.proctech_tips_description);
        TypedArray imageResources = getResources()
                .obtainTypedArray(R.array.proctech_tips_images);
